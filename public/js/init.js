...
jQuery(document).ready(function(){
	...
	function waxon_tm_popupscroll_about(){

		var WW				= jQuery(window).width();
		var H				= jQuery(window).height();
		var scrollable		= jQuery('.waxon_tm_modalbox_about .scrollable');

		var popupBox		= jQuery('.waxon_tm_modalbox_about .description_wrap');
	...
	function waxon_tm_popupscroll(){

		var WW				= jQuery(window).width();
		var H				= jQuery(window).height();
		var scrollable		= jQuery('.waxon_tm_modalbox_news .scrollable');

		var popupBox		= jQuery('.waxon_tm_modalbox_news .description_wrap');
